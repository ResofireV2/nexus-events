defmodule NexusEvents.Migrations.V1CreateNexusEvents do
  use Ecto.Migration

  def change do
    create_if_not_exists table(:nexus_events_events) do
    ...
    create_if_not_exists index(:nexus_events_events, [:post_id])
    create_if_not_exists index(:nexus_events_events, [:status])
    create_if_not_exists index(:nexus_events_events, [:start_at])
    create_if_not_exists index(:nexus_events_events, [:end_at])
    create_if_not_exists index(:nexus_events_events, [:creator_user_id])
  end
end
